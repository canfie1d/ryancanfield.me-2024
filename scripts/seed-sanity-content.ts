...
const UI_STRINGS = {
  ...
  settingsTitle: "The Chamber",
  settingsSubtitle: "Place jewels in their sockets to reveal new paths",
  settingsToggleAbout: "The Eye's Path",
  settingsToggleAboutDesc: "Replaces the about content with character GUI",
  settingsToggleWork: "The Seal's Path",
  settingsToggleWorkDesc: "Replaces the work content with achievements GUI",
  settingsToggleWriting: "The Quill's Path",
  settingsToggleWritingDesc:
    "Replaces the writing content with progress/activity log GUI",
  settingsToggleContact: "The Signet's Path",
  settingsToggleContactDesc:
    "Replaces the contact content with feedback/bug report GUI",
  settingsToggleDelete: "Abandon the Journey",
  settingsToggleDeleteDesc:
    "Those who live close to danger know what they risk. Erases all discoveries and progress.",
  settingsButtonCancel: "Stay",
  settingsButtonDelete: "Abandon",
  inventoryTitle: "Satchel",
  ...
  cardTitleThemes: "Palette",
  cardTitleAchievements: "Triumphs",
  cardTitleLore: "Lore",
  loreCountTotal: 4,
  loadingText: "Loading...",
  loadingMessages: [
