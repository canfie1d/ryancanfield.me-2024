...
export const OPEN_SOURCE: {
...
}[] = [
  {
    ...
    description:
      "A react-scripts fork that added routing, styling and state management out of the box.",
  },
  {
    ...
    description:
      "A website template for easily creating a resume website using create-react-app.",
  },
  {
    ...
    description:
      "A React library that replaces react-router switch to animate between two routes.",
  },
  {
    title: "Slack Statusbot",
    githubUrl: "https://github.com/canfie1d/statusbot",
    description:
      "A Slack bot that allows you to automatically set your Slack status based on your geolocation.",
  },
];
...
export const CONTACT_POINTS: {
  ...
  {
    url: "https://www.twitter.com/canfie1d",
    title: "Twitter",
    icon: "twitter",
  },
  {
